...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?=base_url('assets/images/background/login-register.jpg')?>);">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" method="post" action="<?=base_url('Login/index')?>">
                    <a href="javascript:void(0)" class="text-center db"><img src="<?=base_url('assets/images/application/logo-light-text.png')?>" alt="Home" style="width:150px"/></a>
