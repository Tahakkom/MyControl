                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">
                        ...
                        <span>
                         ...
                         <!-- Light Logo text -->    
                         <img src="<?=base_url('assets/images/application/logo-light-text.gif')?>" class="light-logo" style="width:150px" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>ABC</h5> <span class="mail-desc">Message 1</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>ABC</h5> <span class="mail-desc">Message 2</span> <span class="time">9:10 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>ABC</h5> <span class="mail-desc">Message 3</span> <span class="time">9:08 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>ABC</h5> <span class="mail-desc">Message 4</span> <span class="time">9:02 AM</span> </div>
                                            </a>
                                        </div>
                                    </li>
                                    <li>
